...
const List<TileDefinition> kAllTiles = [
  ...
  TileDefinition(id:'ese_tekrema', name:'Ese Ne Tekrema',meaning:'Teeth and tongue',         symbol:'≋', suit:TileSuit.wisdom,  suitNumber:7,  assetPath:'assets/tiles/symbols/asset v2/ese_ne_trema.png'),
  ...
  TileDefinition(id:'nyame_dua',   name:'Nyame Dua',     meaning:'God\'s tree',              symbol:'✙', suit:TileSuit.earth,   suitNumber:9,  assetPath:'assets/tiles/symbols/asset v2/nyame_dua.png'),
  ...
  TileDefinition(id:'fawohodie',   name:'Fawohodie',     meaning:'Freedom',                  symbol:'☆', suit:TileSuit.royalty, suitNumber:5,  assetPath:'assets/tiles/symbols/asset v2/fawohodie-removebg-preview.png'),
  ...
  TileDefinition(id:'mpuannum',    name:'Mpuannum',      meaning:'Five tufts — royalty',     symbol:'✵', suit:TileSuit.royalty, suitNumber:7,  assetPath:'assets/tiles/symbols/asset v2/mpuannum.png'),
  TileDefinition(id:'okodee',      name:'Okodee Mmowere',meaning:'Eagle talons — strength',  symbol:'⋙', suit:TileSuit.royalty, suitNumber:8),
  TileDefinition(id:'nyame_nwu',   name:'Nyame Nwu Na Mawu', meaning:'God never dies',      symbol:'⟁', suit:TileSuit.royalty, suitNumber:9,  assetPath:'assets/tiles/symbols/asset v2/nyame_nwu_na_mawu.png'),
  ...
  TileDefinition(id:'mpatapo',     name:'Mpatapo',       meaning:'Reconciliation',          symbol:'⊗', suit:TileSuit.honor,   suitNumber:4,  assetPath:'assets/tiles/symbols/asset v2/mpatapo.png'),
  TileDefinition(id:'hye_wo_nhye', name:'Hye Wo Nhye',   meaning:'Imperishability',         symbol:'◇', suit:TileSuit.honor,   suitNumber:5,  assetPath:'assets/tiles/symbols/asset v2/hye_wo_nhye.png'),
