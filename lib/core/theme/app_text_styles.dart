...
class AppTextStyles {
  ...
  static TextStyle get archiveDisplayMedium => GoogleFonts.cinzel(
        fontSize: 24,
        fontWeight: FontWeight.bold,
        color: AppColors.archiveInk,
        letterSpacing: 1.5,
  ...
  static TextStyle get archiveHeadlineMedium => GoogleFonts.cinzel(
        fontSize: 20,
        fontWeight: FontWeight.w600,
        color: AppColors.archiveInk,
      );
  ...
  static TextStyle get archiveTitleMedium => GoogleFonts.nunito(
        fontSize: 16,
        fontWeight: FontWeight.w700,
        color: AppColors.archiveInk,
      );

  static TextStyle get archiveBodyLarge => GoogleFonts.nunito(
        fontSize: 16,
        fontWeight: FontWeight.normal,
        color: AppColors.archiveInk,
      );
